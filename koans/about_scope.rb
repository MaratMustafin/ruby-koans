...
class AboutScope < Neo::Koan
  ...
  p AboutScope::String.object_id == String.object_id
  p String.object_id == "HI".object_id
  p ::String.object_id == "HI".object_id
  p ::String.object_id
  p "HI".class.object_id
  p String.object_id
  def test_bare_bones_class_names_assume_the_current_scope
    assert_equal true, AboutScope::String.object_id == String.object_id
  end
